...
tar -C netpunch -cf - lobby.py punch.py seal.py connect.py mesh.py observe.py modshare.py desynclogs.py updater.py sync_lobby.py sync_operation.py sync_runtime.py sync_snapshot.py player_stats.py 2>/dev/null \

#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: dev 1d0ca473."""
import argparse
import hashlib
...
REFERENCE = "1d0ca47338ff40f797a09bfcf793fd5dd08ba317"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact dev 1d0ca473 except {len(MERGED_SHA256)} pinned cumulative merges")

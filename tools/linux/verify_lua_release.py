#!/usr/bin/env python3
"""Verify that Linux ships the exact Lua sources from Windows release 0.5.6."""
import argparse
import hashlib
...
REFERENCE = "e4702669ab99ae05074dc5b5540dbc1115e66129"
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files match Windows 0.5.6 ({commit}) byte for byte")

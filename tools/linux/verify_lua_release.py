#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: Windows 0.7.0.2 + dev e43d01dd."""
import argparse
import hashlib
...
REFERENCE = "e43d01ddc55c999c3fdc22d8a31d2add925c0530"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact Windows 0.7.0.2 + dev e43d01dd except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact Windows 0.7.0.2 + dev e43d01dd")
        return 0

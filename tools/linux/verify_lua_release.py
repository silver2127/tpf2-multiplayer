#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: dev d129fab7 (release 0.6)."""
import argparse
import hashlib
...
REFERENCE = "d129fab7ac343b62f0c6fcda2f5b2a5a25af312c"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact dev d129fab7 (release 0.6) except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact dev d129fab7 (release 0.6)")
        return 0

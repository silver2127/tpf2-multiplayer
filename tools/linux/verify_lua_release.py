#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: dev 66c870cf."""
import argparse
import hashlib
...
REFERENCE = "66c870cfb4595d361d5c65221516cd1dcb967284"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact dev 66c870cf except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact dev 66c870cf")
        return 0

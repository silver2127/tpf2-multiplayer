#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: Windows v0.6.1.25."""
import argparse
import hashlib
...
REFERENCE = "b77602599fbec3e3690de1430e28241c1a803f83"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact Windows v0.6.1.25 except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact Windows v0.6.1.25")
        return 0

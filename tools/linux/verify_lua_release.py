#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: Windows 0.7 + dev 8c3c02a5."""
import argparse
import hashlib
...
REFERENCE = "8c3c02a5a886151c54133669dae9ef2437644d28"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact Windows 0.7 + dev 8c3c02a5 except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact Windows 0.7 + dev 8c3c02a5")
        return 0

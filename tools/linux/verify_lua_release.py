#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: Windows 0.7 + dev 12407af7."""
import argparse
import hashlib
...
REFERENCE = "12407af7c3bb9c5624a34b8b09242f4fbf1eaac0"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact Windows 0.7 + dev 12407af7 except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact Windows 0.7 + dev 12407af7")
        return 0

#!/usr/bin/env python3
"""Verify that Linux ships the exact Lua sources from Windows release 0.4.22."""
import argparse
import hashlib
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files match Windows 0.4.22 ({commit}) byte for byte")

#!/usr/bin/env python3
"""Verify the cumulative Linux Lua integration: Windows 0.7.0.2 + dev bd69b864."""
import argparse
import hashlib
...
REFERENCE = "bd69b864737a4c4383c6d73ac8d1dc8fa6f1c8b7"
INCOMING = REFERENCE
INCOMING_FILES = set()
...
def main():
    ...
    try:
        ...
        print(f"PASS: {len(expected)} Lua files: exact Windows 0.7.0.2 + dev bd69b864 except {len(MERGED_SHA256)} pinned cumulative merges")
        ...
        if bad_glyphs:
            return 1
        print(f"PASS: {len(expected_glyphs)} HUD glyph textures exact Windows 0.7.0.2 + dev bd69b864")
        return 0

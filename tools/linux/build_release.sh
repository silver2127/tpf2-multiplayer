...
install -m 0644 "$REPO/docs/linux/UPSTREAM_dev_6e5eec30.md" "$STAGE/UPSTREAM_dev_6e5eec30.md"
...
CXX=$(sed -n 's/^CMAKE_CXX_COMPILER:[A-Z]*=//p' "$BUILD/CMakeCache.txt" | head -n 1)
{
  ...
  echo "Lua: Windows v0.6.1.28 6e5eec302bb2d9fdfca70fa44499938efdfddb2c (pinned Linux origin replay)"

...
install -m 0644 "$REPO/docs/linux/UPSTREAM_dev_0620342e.md" "$STAGE/UPSTREAM_dev_0620342e.md"
...
CXX=$(sed -n 's/^CMAKE_CXX_COMPILER:[A-Z]*=//p' "$BUILD/CMakeCache.txt" | head -n 1)
{
  ...
  echo "Lua: Windows v0.6.1.28 0620342ee15cd41a6634a09384a4ef844d8ab09d (pinned Linux origin replay)"

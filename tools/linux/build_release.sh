...
install -m 0644 "$REPO/docs/linux/UPSTREAM_dev_b406a913.md" "$STAGE/UPSTREAM_dev_b406a913.md"
...
CXX=$(sed -n 's/^CMAKE_CXX_COMPILER:[A-Z]*=//p' "$BUILD/CMakeCache.txt" | head -n 1)
{
  ...
  echo "Lua: Windows dev b406a9139676d63d67f61b4e7b77699c2070f0f8, verified byte-identical"
  echo "libraries: ${LIBS[*]}"

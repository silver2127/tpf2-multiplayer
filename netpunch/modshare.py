...
def request_catalogue():
    ...
    # No count cap (129 lines until 2026-09-16): every consented download is
    # registered. NOTE the native reader, native/src/workshop_register.cpp,
    # still throws "registry limit" past 128 entries or a 4096-byte line; a
    # registry that trips it is refused by the game side and shows up as
    # "mods not recognised by game" on the joiner, never as a silent skip.

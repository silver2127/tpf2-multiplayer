...
int main(int argc, char**) {
    ...
    const int expectedRate = messagesMode ? SteamRateController::Initial : 16*1024*1024;
    assert(configValues.size()==4 && configValues[10]==expectedRate && configValues[11]==expectedRate);

...
integration includes Windows **experimental release 0.6.1.28** (`49b1f277`) and a native
dedicated server. See [Linux installation](docs/linux/INSTALL.md),
[current integration and test evidence](docs/linux/UPSTREAM_dev_49b1f277.md), and

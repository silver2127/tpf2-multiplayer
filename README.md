...
integration includes Windows **experimental release 0.6.1.25** (`b7760259`) and a native
dedicated server. See [Linux installation](docs/linux/INSTALL.md),
[current integration and test evidence](docs/linux/UPSTREAM_dev_b7760259.md), and

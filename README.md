...
integration is Windows **0.5.7 plus dev through `a658fc11`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_a658fc11.md), and

...
integration is Windows **0.5.7 plus dev through `38432b5f`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_38432b5f.md), and

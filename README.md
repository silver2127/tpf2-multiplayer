...
integration includes Windows **experimental release 0.6.1.27** (`66a584cb`) and a native
dedicated server. See [Linux installation](docs/linux/INSTALL.md),
[current integration and test evidence](docs/linux/UPSTREAM_dev_66a584cb.md), and

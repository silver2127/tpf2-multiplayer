...
integration is Windows **0.5.7 plus dev through `d3135a59`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_d3135a59.md), and

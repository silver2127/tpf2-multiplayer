...
integration is Windows **0.5.7 plus dev through `1d0ca473`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_1d0ca473.md), and

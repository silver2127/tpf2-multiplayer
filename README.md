...
integration is Windows **0.5.7 plus dev through `5fb7aea2`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_5fb7aea2.md), and

...
integration is Windows **0.5.6 plus dev `55e97a48` and `3edfbccd`**, retaining the earlier dashboard tabs. See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_3edfbccd.md), and

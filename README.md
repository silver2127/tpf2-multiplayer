...
integration is Windows **0.5.7 plus dev through `be3b86ae`** (partial native integration). See [Linux installation](docs/linux/INSTALL.md),
[the integration record](docs/linux/UPSTREAM_dev_be3b86ae.md), and

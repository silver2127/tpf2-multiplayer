...
integration includes Windows **experimental release 0.6.1.26** (`1eb30002`) and a native
dedicated server. See [Linux installation](docs/linux/INSTALL.md),
[current integration and test evidence](docs/linux/UPSTREAM_dev_1eb30002.md), and

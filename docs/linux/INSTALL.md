...
This development tree combines **0.5.7 plus Windows dev through `59bb258a`**.
...
[UPSTREAM_dev_59bb258a.md](UPSTREAM_dev_59bb258a.md) for provenance, tests and
...
Windows revision. Founder names, buy-time paint scheduling and the optional

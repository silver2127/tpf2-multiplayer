...
This development tree combines **0.5.7 plus Windows dev through `d6db920f`**.
...
[UPSTREAM_dev_d6db920f.md](UPSTREAM_dev_d6db920f.md) for provenance, tests and
...
unavailable; stylesheet presence does not enable company tinting on Linux.
